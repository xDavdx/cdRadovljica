...
import { blog3 } from '../data/zanimivosti-storage'
  ...
  return (
    <div className='zgodovina-grid'>
        ...
        <div className='zgodovina-slika'>
            <img className='naslovi-slika' src={blog3.slika} alt="" width={'100%'} />
        </div>
        ...
        <div className='zgodovina-text1'>
            ...
            <h1 className='m0'>{blog3.naslov1}</h1>
        ...
        <div className='zgodovina-text2'>
            <h1 className='m0'>{blog3.naslov2}</h1>
            <p className='font16 grey'>
                {blog3.drugiOdstavek}
                    <br /> <br />
                {blog3.tretjiOdstavek}

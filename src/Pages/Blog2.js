...
import { blog2 } from '../data/zanimivosti-storage'
  ...
  return (
    <div className='zgodovina-grid'>
        ...
        <div className='zgodovina-slika'>
            <img className='naslovi-slika' src={blog2.slika} alt="" width={'100%'} />
        </div>
        ...
        <div className='zgodovina-text1'>
            ...
            <h1 className='m0'>{blog2.naslov1}</h1>
        ...
        <div className='zgodovina-text2'>
            <h1 className='m0'>{blog2.naslov2}</h1>
            <p className='font16 grey'>
                {blog2.drugiOdstavek}
                    <br /> <br />
                {blog2.tretjiOdstavek}
